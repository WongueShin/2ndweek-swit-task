...
`--force` 키워드를 사용하여 해당 이슈를 해결하고 경험을 블로그에 작성하였습니다.
  
[Blog - Peer Dependency🚀](https://zerochae.github.io/issue/2022/02/11/peerDependency/)
...
- 🎈권영채 : 화면 공유를 통하여 마치 같은 공간에서 하나의 모니터를 보고 협업하는 페어 프로그래밍의 느낌을 받이 많을 수 있는 프로젝트였습니다. 이슈 발생 시, 동료가 같이 고민 해주고 서로 다른 해결책을 제시하고 그 이유를 설명하는 부분에서 재미를 느꼈습니다. 
